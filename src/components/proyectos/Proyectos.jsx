...
const Proyectos = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const whatsapp = `Confirmamos la asistencia de 🧡 ${nombreCompleto} 🧡. Nro de transferencia 💸 ${comprobante}. Las canciones que no pueden faltar 🎶 ${mensaje}`;
    ...
    <>
      ...
      >
        <div className="row marMob ">
            <hr />
            <h3 className="text-center fs-6">Cómo llegar?</h3>
            <hr />
            <iframe
